...
def test_purepath_glob_hit():
    staged = ["a.py", "src/deep/tool.py", "src/x.js", "src/y.js", "src/sub/y.js", "readme.md"]
    assert check_forbidden_paths(staged, ["*.py"]) == ["a.py", "src/deep/tool.py"]
    assert check_forbidden_paths(staged, ["src/*.js"]) == ["src/x.js", "src/y.js"]


def test_purepath_glob_star_does_not_cross_slash():
    staged = ["docs/a.md", "docs/sub/b.md"]
    assert check_forbidden_paths(staged, ["docs/*"]) == ["docs/a.md"]
